...
class TestDatabaseCommands(unittest.TestCase):
    ...
    #     self.assertSetEqual({(self.file_system, inode, filename, 1, "s42")}, self.testDB._str_rels_for_tag_equals_condition(tagname, "s42"))
    #     self.assertSetEqual(set(), self.testDB._str_rels_for_tag_equals_condition(tagname, "s43"))
    ...
    #     self.assertSetEqual({(self.file_system, inode, filename, 1, 42)}, self.testDB._int_rels_for_tag_equals_condition(tagname, 42))
    #     self.assertSetEqual(set(), self.testDB._int_rels_for_tag_equals_condition(tagname, 43))
    ...
    #     self.assertTrue((1, 1, 1, 42) in self.testDB.dump_tables()['rel_file_tag_int'])
    #     self.assertDictEqual({tagname:42}, self.testDB.get_rels_for_file(self.file_system, inode))
    #     self.assertSetEqual({(self.file_system, inode, filename, 1, 42)}, self.testDB._int_rels_for_tag_range_condition(tagname, 5, 50))
    #     self.assertSetEqual({(self.file_system, inode, filename, 1, 42)}, self.testDB._int_rels_for_tag_range_condition(tagname, 5, None))
    #     self.assertSetEqual({(self.file_system, inode, filename, 1, 42)}, self.testDB._int_rels_for_tag_range_condition(tagname, None, 50))
    #     with self.assertRaises(Exception):
    #         self.assertSetEqual({(self.file_system, inode, filename, 1, 42)}, self.testDB._int_rels_for_tag_range_condition(tagname, None, None))
    #     self.assertSetEqual(set(), self.testDB._int_rels_for_tag_range_condition(tagname, 50, 90))
